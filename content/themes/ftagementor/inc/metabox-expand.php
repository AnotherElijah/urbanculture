...
*/
// Text Transform
function ftagementor_text_transform_options( $value = false ) {
	$text_transform_options_list = array( 
		''						=> esc_html__( 'Select', 'ftagementor' ), 
		'lowercase'				=> esc_html__( 'lowercase', 'ftagementor' ), 
		'uppercase'				=> esc_html__( 'UPPERCASE', 'ftagementor' ), 
		'capitalize'			=> esc_html__( 'Capitalize', 'ftagementor' ), 
		'none'					=> esc_html__( 'none', 'ftagementor' ), 
		'inherit'				=> esc_html__( 'inherit', 'ftagementor' ), 
	);
...
// Font Weight
function ftagementor_font_weight_options( $value = false ) {
	$font_weight_options_list = array( 
		''					=> esc_html__( 'Select', 'ftagementor' ), 
		'100'				=> esc_html__( '100', 'ftagementor' ), 
		'200'				=> esc_html__( '200', 'ftagementor' ), 
		'300'				=> esc_html__( '300', 'ftagementor' ), 
		'400'				=> esc_html__( '400', 'ftagementor' ), 
		'500'				=> esc_html__( '500', 'ftagementor' ), 
		'600'				=> esc_html__( '600', 'ftagementor' ), 
		'700'				=> esc_html__( '700', 'ftagementor' ), 
		'800'				=> esc_html__( '800', 'ftagementor' ), 
		'900'				=> esc_html__( '900', 'ftagementor' ), 
	);
	$font_weight_options = '';
...
// Font Style
function ftagementor_font_style_options( $value = false ) {
	$font_style_options_list = array( 
		''					=> esc_html__( 'Select', 'ftagementor' ), 
		'normal'				=> esc_html__( 'Normal', 'ftagementor' ), 
		'italic'				=> esc_html__( 'Italic', 'ftagementor' ), 
	);
	$font_style_options = '';
...
function ftagementor_render_typography_field_callback( $field, $value, $object_id, $object_type, $field_type ) {
	...
	?>
	<!-- Font Family -->
	<div class="one-four"><p><label for="<?php echo esc_attr($field_type->_id( '_font-family' )); ?>"><?php esc_html_e( 'Font Family', 'ftagementor' ); ?></label></p>
	...
	<!-- Font Size -->
	<div class="one-four"><p><label for="<?php echo esc_attr($field_type->_id( '_font-size' )); ?>"><?php esc_html_e( 'Font Size', 'ftagementor' ); ?></label></p>
		<?php echo _($field_type->input( array(
	...
	<!-- Line Height -->
	<div class="one-four"><p><label for="<?php echo esc_attr($field_type->_id( '_line-height' )); ?>"><?php esc_html_e( 'Line Height', 'ftagementor' ); ?></label></p>
		<?php echo _($field_type->input( array(
	...
	<!-- Letter Spacing -->
	<div class="one-four"><p><label for="<?php echo esc_attr($field_type->_id( '_letter-spacing' )); ?>"><?php esc_html_e( 'Letter Spacing', 'ftagementor' ); ?></label></p>
		<?php echo _($field_type->input( array(
	...
	<!-- Text Transform -->
	<div class="one-four"><p><label for="<?php echo esc_attr($field_type->_id( '_text-transform' )); ?>"><?php esc_html_e( 'Text Transform', 'ftagementor' ); ?></label></p>
		<?php echo _($field_type->select( array(
			...
			'desc'  => '',
			'options' => ftagementor_text_transform_options( $value['text-transform'] ),
		) ) ); ?>
	</div>
	<!-- Font Weight -->
	<div class="one-four"><p><label for="<?php echo esc_attr($field_type->_id( '_font-weight' )); ?>"><?php esc_html_e( 'Font Weight', 'ftagementor' ); ?></label></p>
		<?php echo _($field_type->select( array(
			'name'  => $field_type->_name( '[font-weight]' ),
			'id'    => $field_type->_id( '_font-weight' ),
			'value' => $value['font-weight'],
			'desc'  => '',
			'options' => ftagementor_font_weight_options( $value['font-weight'] ),
		) ) ); ?>
	</div>
	<!-- Font Style -->
	<div class="one-four"><p><label for="<?php echo esc_attr($field_type->_id( '_font-style' )); ?>"><?php esc_html_e( 'Font style', 'ftagementor' ); ?></label></p>
		<?php echo _($field_type->select( array(
			'name'  => $field_type->_name( '[font-style]' ),
			'id'    => $field_type->_id( '_font-style' ),
			'value' => $value['font-style'],
			'desc'  => '',
			'options' => ftagementor_font_style_options( $value['font-style'] ),
		) )); ?>
	</div>
	<!-- Font Color -->
	<div  class="custom-color-field"><p><label for="<?php echo esc_attr($field_type->_id( '_font-color' )); ?>"><?php esc_html_e( 'Font Color', 'ftagementor' ); ?></label></p>
		<?php echo _($field_type->input( array(
...
add_filter( 'cmb2_render_typography', 'ftagementor_render_typography_field_callback', 10, 5 );
...
// Background Repeat
function ftagementor_background_repeat_options( $value = false ) {
	$background_repeat_options_list = array( 
		''				=> esc_html__( 'Select', 'ftagementor' ), 
		'repeat'		=> esc_html__( 'Repeat', 'ftagementor' ), 
		'repeat-x'		=> esc_html__( 'Repeat-X', 'ftagementor' ), 
		'repeat-y'		=> esc_html__( 'Repeat-Y', 'ftagementor' ), 
		'no-repeat'		=> esc_html__( 'No-Repeat', 'ftagementor' ), 
		'initial'		=> esc_html__( 'Initial', 'ftagementor' ), 
		'inherit'		=> esc_html__( 'Inherit', 'ftagementor' ),
	);
...
// Background Size
function ftagementor_background_size_options( $value = false ) {
	$background_size_options_list = array( 
		''				=> esc_html__( 'Select', 'ftagementor' ), 
		'cover'			=> esc_html__( 'Cover', 'ftagementor' ), 
		'contain'		=> esc_html__( 'Contain', 'ftagementor' ), 
		'inherit'		=> esc_html__( 'Inherit', 'ftagementor' ), 
		'initial'		=> esc_html__( 'Initial', 'ftagementor' ), 
		'unset'			=> esc_html__( 'Unset', 'ftagementor' ),
	);
...
function ftagementor_background_attachment_options( $value = false ) {
	$background_attachment_options_list = array( 
		''				=> esc_html__( 'Select', 'ftagementor' ), 
		'scroll'		=> esc_html__( 'Scroll', 'ftagementor' ), 
		'fixed'			=> esc_html__( 'Fixed', 'ftagementor' ), 
		'local'			=> esc_html__( 'Local', 'ftagementor' ), 
		'inherit'		=> esc_html__( 'Inherit', 'ftagementor' ), 
		'initial'		=> esc_html__( 'Initial', 'ftagementor' ), 
		'unset'			=> esc_html__( 'Unset', 'ftagementor' ),
	);
...
// Background Position
function ftagementor_background_position_options( $value = false ) {
	$background_position_options_list = array( 
		''					=> esc_html__( 'Select', 'ftagementor' ), 
		'left top'			=> esc_html__( 'Left Top', 'ftagementor' ), 
		'left center'		=> esc_html__( 'Left Center', 'ftagementor' ), 
		'left bottom'		=> esc_html__( 'Left Bottom', 'ftagementor' ), 
		'center top'		=> esc_html__( 'Center Top', 'ftagementor' ), 
		'center center'		=> esc_html__( 'Center Center', 'ftagementor' ), 
		'center bottom'		=> esc_html__( 'Center Bottom', 'ftagementor' ), 
		'right top'			=> esc_html__( 'Right Top', 'ftagementor' ), 
		'right center'		=> esc_html__( 'Right Center', 'ftagementor' ), 
		'right bottom'		=> esc_html__( 'Right Bottom', 'ftagementor' ), 
	);
...
function ftagementor_render_background_field_callback( $field, $value, $object_id, $object_type, $field_type ) {
	...
	<div class="custom-color-field"><p><label for="<?php echo esc_attr($field_type->_id( '_background-color' )); ?>"><?php esc_html_e( 'Background Color', 'ftagementor' ); ?></label></p>
		<?php echo _($field_type->input( array(
	...
	<div class="one-four"><p><label for="<?php echo esc_attr($field_type->_id( '_background-repeat' )); ?>"><?php esc_html_e( 'Background Repeat', 'ftagementor' ); ?></label></p>
		<?php echo _($field_type->select( array(
			'name'  => $field_type->_name( '[background-repeat]' ),
			'id'    => $field_type->_id( '_background-repeat' ),
			'value' => $value['background-repeat'],
			'desc'  => '',
			'class'  => 'ftagementor-select',
			'options' => ftagementor_background_repeat_options( $value['background-repeat'] ),

		) ) ); ?>
	</div>

	<div class="one-four"><p><label for="<?php echo esc_attr($field_type->_id( '_background-size' )); ?>"><?php esc_html_e( 'Background Size', 'ftagementor' ); ?></label></p>
		<?php echo _($field_type->select( array(
			...
			'desc'  => '',
			'class'  => 'ftagementor-select',
			'options' => ftagementor_background_size_options( $value['background-size'] ),

		) ) ); ?>
	</div>

	<div class="one-four"><p><label for="<?php echo esc_attr($field_type->_id( '_background-attachment' )); ?>"><?php esc_html_e( 'Background Attachment', 'ftagementor' ); ?></label></p>
		<?php echo _($field_type->select( array(
			...
			'desc'  => '',
			'class'  => 'ftagementor-select',
			'options' => ftagementor_background_attachment_options( $value['background-attachment'] ),

		) ) ); ?>
	</div>

	<div class="one-four"><p><label for="<?php echo esc_attr($field_type->_id( '_background-position' )); ?>"><?php esc_html_e( 'Background Position', 'ftagementor' ); ?></label></p>
		<?php echo _($field_type->select( array(
			...
			'desc'  => '',
			'class'  => 'ftagementor-select',
			'options' => ftagementor_background_position_options( $value['background-position'] ),

		) ) ); ?>
	</div>
	
	<div><p><label for="<?php echo esc_attr($field_type->_id( '_background-image' )); ?>"><?php esc_html_e( 'Background Image', 'ftagementor' ); ?></label></p>
		<?php echo _($field_type->input( array(
			'type'  			=> 'text',
		...
		<?php echo _($field_type->input( array(
			...
			'desc'  			=> '',
			'value'  			=> esc_html__( 'Add or Upload File', 'ftagementor'),
		) ) ); ?>
		...
		<div id="<?php echo esc_attr($field_type->_id( '-status' )); ?>"  class="cmb2-media-status">
			...
			<div class="img-status cmb2-media-item">
				<img style="max-width: 350px; width: 100%;" src="<?php echo esc_url($value['background-image']); ?>" class="cmb-file-field-image" alt="<?php echo esc_attr('Preview Image') ?>">
				<p class="cmb2-remove-wrapper">
					<a href="#" class="cmb2-remove-file-button" rel="<?php echo esc_attr($field_type->_id( '-status' )); ?>"><?php esc_html_e( 'Remove Image', 'ftagementor' ); ?></a>
				</p>
			</div>
			<?php endif; ?>
		</div>
...
add_filter( 'cmb2_render_background', 'ftagementor_render_background_field_callback', 10, 5 );


/**
* Type Padding 
*/
function ftagementor_render_padding_field_callback( $field, $value, $object_id, $object_type, $field_type ) {
	...
	?>
	<!-- Padding Top -->
	<div class="one-four"><p><label for="<?php echo esc_attr($field_type->_id( '_padding-top' )); ?>"><?php esc_html_e( 'Top', 'ftagementor' ); ?></label></p>
		<?php echo _($field_type->input( array(
	...
	<!-- Padding Right -->
	<div class="one-four"><p><label for="<?php echo esc_attr($field_type->_id( '_padding-right' )); ?>"><?php esc_html_e( 'Right', 'ftagementor' ); ?></label></p>
		<?php echo _($field_type->input( array(
	...
	<!-- Padding Bottom -->
	<div class="one-four"><p><label for="<?php echo esc_attr($field_type->_id( '_padding-bottom' )); ?>"><?php esc_html_e( 'Bottom', 'ftagementor' ); ?></label></p>
		<?php echo _($field_type->input( array(
	...
	<!-- Padding Left -->
	<div class="one-four"><p><label for="<?php echo esc_attr($field_type->_id( '_padding-left' )); ?>"><?php esc_html_e( 'Left', 'ftagementor' ); ?></label></p>
		<?php echo _($field_type->input( array(
...
add_filter( 'cmb2_render_padding', 'ftagementor_render_padding_field_callback', 10, 5 );


/**
* Type Margin
*/
function ftagementor_render_margin_field_callback( $field, $value, $object_id, $object_type, $field_type ) {
	...
	?>
	<!-- Margin Top -->
	<div class="one-four"><p><label for="<?php echo esc_attr($field_type->_id( '_margin-top' )); ?>"><?php esc_html_e( 'Top', 'ftagementor' ); ?></label></p>
		<?php echo _($field_type->input( array(
	...
	<!-- Margin Right -->
	<div class="one-four"><p><label for="<?php echo esc_attr($field_type->_id( '_margin-right' )); ?>"><?php esc_html_e( 'Right', 'ftagementor' ); ?></label></p>
		<?php echo _($field_type->input( array(
	...
	<!-- Margin Bottom -->
	<div class="one-four"><p><label for="<?php echo esc_attr($field_type->_id( '_margin-bottom' )); ?>"><?php esc_html_e( 'Bottom', 'ftagementor' ); ?></label></p>
		<?php echo _($field_type->input( array(
	...
	<!-- Margin Left -->
	<div class="one-four"><p><label for="<?php echo esc_attr($field_type->_id( '_margin-left' )); ?>"><?php esc_html_e( 'Left', 'ftagementor' ); ?></label></p>
		<?php echo _($field_type->input( array(
...
add_filter( 'cmb2_render_margin', 'ftagementor_render_margin_field_callback', 10, 5 );
...
*/
function ftagementor_render_hash_colorpicker_field_callback( $field, $value, $object_id, $object_type, $field_type ) {
	...
	?>
	<!-- Color -->
	<div class="custom-color-field hash-colorpicker"><p><label for="<?php echo esc_attr($field_type->_id( '_color' ) ); ?>"><?php esc_html_e( 'Color', 'ftagementor' ); ?></label></p>
		<?php echo _($field_type->input( array(
...
add_filter( 'cmb2_render_hash_colorpicker', 'ftagementor_render_hash_colorpicker_field_callback', 10, 5 );


/**
* Conditional Fields
*/
if ( ! class_exists( 'ftagementor_cmb2_conditionals' ) ) {

	/**
	 * ftagementor_cmb2_conditionals Plugin.
	 */
	class ftagementor_cmb2_conditionals {
		 ...
		 * @var array
		 */
		protected $ftagementor_maybe_required_form_elms = array(
			'list_input',
			'input',
			'textarea',
			'input',
		...
		public function __construct() {
			...
			foreach ( $this->ftagementor_maybe_required_form_elms as $element ) {
				add_filter( "cmb2_{$element}_attributes", array( $this, 'ftagementor_maybe_set_required_attribute' ), self::PRIORITY );
			}
		}
		 ...
		 * @return array
		 */
		public function ftagementor_maybe_set_required_attribute( $args ) {
	...
	if ( ! function_exists( 'cmb2_conditionals_init' ) ) {
		...
		function cmb2_conditionals_init() {
			$cmb2_conditionals = new ftagementor_cmb2_conditionals();
		}
	}
