<?php
    ...
    if( !function_exists('wpfilm_custom_post_register') ){
        ...
        function wpfilm_custom_post_register(){
            ...
            $labels = array(
                'name'                  => _x( 'Movies', 'Post Type General Name', 'wpfilm-studio' ),
      ...
      //Trailer Post Type
       ...
       register_taxonomy('wpfilm_trailer_category','wpfilm_trailer',$args);
            ...
            $labels = array(
                'name'                  => _x( 'Campaigns', 'Post Type General Name', 'wpfilm-studio' ),
          ...
          add_action( 'init', 'wpfilm_custom_post_register', 0 );
