    ...
    protected function render( $instance = [] ) {
        ...
        ?>
            <div class="campaigns-area">
                <div class="<?php if($iteam_layout == 'carosul'){ echo 'campaign-active indicator-style-two '.$sectionid; } else echo 'row';?>">
                    <?php
       ...
       <?php } ?>
            ...
            <script type="text/javascript">
                ...
                (function($){
                    ...
                    $('.campaign-active.<?php echo $sectionid;?>').slick({
...
Plugin::instance()->widgets_manager->register_widget_type( new WPFilm_Elementor_Widget_Campaign() );