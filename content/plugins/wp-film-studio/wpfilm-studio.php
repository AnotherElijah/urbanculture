...
function wpfilm_movie_single_template_modify($single) {
    ...
    if ( $post->post_type == 'wpfilm_movie' ) {
        if ( file_exists( WPFILM_ADDONS_PL_PATH . '/single-wpfilm_movie.php' ) ) {
            return WPFILM_ADDONS_PL_PATH . '/single-wpfilm_movie.php';
        }
    }
    /* Checks for single template by post type */
    if ( $post->post_type == 'wpcampaign' ) {
        if ( file_exists( WPFILM_ADDONS_PL_PATH . '/single-wpcampaign.php' ) ) {
            return WPFILM_ADDONS_PL_PATH . '/single-wpcampaign.php';
        }
    }
...
function wpfilm_movie_archive_modify($archive) {
    ...
    if ( $post->post_type == 'wpfilm_movie' ) {
        if ( file_exists( WPFILM_ADDONS_PL_PATH . '/archive-wpfilm_movie.php' ) ) {
            return WPFILM_ADDONS_PL_PATH . '/archive-wpfilm_movie.php';
        }
    }
...
function wpfilm_pro_tab_advertise(){
    echo '<h3> <a target="_blank" href="https://themeforest.net/item/ftage-movie-film-marketing-wordpress-theme/20705434?ref=AslamHasib">
Movie Production, Film Studio, Creative & Entertainment Wordpress Theme</a><h3/> <a target="_blank" href="https://themeforest.net/item/ftage-movie-film-marketing-wordpress-theme/20705434?ref=AslamHasib"><img alt="Movie Production, Film studio, Creative &amp; Entertainment Wordpress Theme - Film &amp; TV Entertainment" src="https://s3.envato.com/files/237145798/preview.__large_preview.png"></a>';
}