...
if ( !class_exists('Ftage_Author_About_Widget') ) {
	class Ftage_Author_About_Widget extends WP_Widget{

		function __construct(){

			$widget_options = array(
				'description' 					=> esc_html__('This widget show author informations', 'ftagementor'), 
				'customize_selective_refresh' 	=> true,
			);

			parent:: __construct('Ftage_Author_About_Widget', esc_html__( 'Ftage: Author Informations', 'ftagementor'), $widget_options );
		...
		public function widget($args, $instance){ 
	        ...
	        <?php echo wp_kses_post($args['before_widget']); ?>
	        	<div class="author--info--wrap">
	        		...
	        		<?php if ( !empty($image) ): ?>
	        			<img src="<?php echo esc_url( $image ) ; ?>" alt="<?php echo esc_attr('Author Image'); ?>">
	        		<?php endif ?>
		...
		public function form($instance){ 
			...
			<div class="image_box_wrap" style="margin:20px 0 15px 0; width: 100%;">
				<button class="button button-primary author_info_image">
					<?php esc_html_e('Upload Image', 'ftagementor'); ?>
				</button>
				<div class="image_box widefat">
					<img src="<?php if( !empty($image)){echo esc_html($image);} ?>" style="margin:15px 0 0 0;padding:0;max-width: 100%;display:inline-block; height: auto;" alt="<?php echo esc_attr('image'); ?>" />
				</div>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('content')); ?>"><?php echo esc_html__('Content:' ,'ftagementor') ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('social_title')); ?>"><?php echo esc_html__('Social Title:' ,'ftagementor') ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('instagram')); ?>"><?php echo esc_html__('Instagram Link:' ,'ftagementor') ?></label>
...
function Ftage_Author_About_Widget() {
    register_widget( 'Ftage_Author_About_Widget' );
}
add_action( 'widgets_init', 'Ftage_Author_About_Widget' );