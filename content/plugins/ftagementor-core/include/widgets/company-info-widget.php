 ...
 */
 if( !class_exists('ftagementor_description_Widget') ){
	class ftagementor_description_Widget extends WP_Widget{
		/**
		 * Register widget with WordPress.
		 */
		function __construct(){
			$widget_ops = array( 'description' => esc_html__('Our short description  .','ftagementor'),'customize_selective_refresh' => true, );
			parent:: __construct('ftagementor_description_Widget', esc_html__('Ftage: Short Description','ftagementor'),$widget_ops );
		}
		/**
		...
		?>
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('image')); ?>"><?php echo esc_html__('Upload Image:','ftagementor');?></label>
					<?php if(!empty($image)){ ?>
					...
					<a href="#" id="custom_media_button" style="margin-top:10px;" class="button button-primary custom_media_button"><?php esc_html_e('Upload', 'ftagementor'); ?></a>
			</p>
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('text')); ?>"><?php echo esc_html__('Content:' ,'ftagementor') ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('phonenumber')); ?>"><?php echo esc_html__('Phone Number:' ,'ftagementor') ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('rss')); ?>"><?php echo esc_html__('Rss Link:' ,'ftagementor') ?></label>
...
function ftagementor_description_Widget() {
    register_widget( 'ftagementor_description_Widget' );
}
add_action( 'widgets_init', 'ftagementor_description_Widget' );