...
if ( !class_exists('Ftage_Single_Banner') ) {
	class Ftage_Single_Banner extends WP_Widget{

		function __construct(){

			$widget_options = array(
				'description' 					=> esc_html__('This widget show banner', 'ftagementor'), 
				'customize_selective_refresh' 	=> true,
			);

			parent:: __construct('Ftage_Single_Banner', esc_html__( 'Ftage: Banner', 'ftagementor'), $widget_options );
	        ...
	        <?php echo wp_kses_post($args['before_widget']); 
				...
				if ( !empty($image) ): ?>
        			<div class="sidebar-banner">
        				<?php if ($banner_link): ?><a href="<?php echo esc_url( $banner_link ); ?>"> <?php endif ?><img src="<?php echo esc_url( $image ) ; ?>" alt="<?php echo esc_attr('Banner Image'); ?>"><?php if ($banner_link): ?>
        					</a>
        				<?php endif ?>
        			</div>
        		<?php endif ?>
		...
		public function form($instance){ 
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('banner_link')); ?>"><?php echo esc_html__('Banner Link:' ,'ftagementor') ?></label>
...
function Ftage_Single_Banner() {
    register_widget( 'Ftage_Single_Banner' );
}
add_action( 'widgets_init', 'Ftage_Single_Banner' );