 ...
 */
 if( !class_exists('Ftage_Newsletter_Widget') ){
	class Ftage_Newsletter_Widget extends WP_Widget{
		/**
		 * Register widget with WordPress.
		 */
		function __construct(){
			$widget_ops = array( 'description' => esc_html__('Ftage contact for address email and phone no.','ftagementor'),'customize_selective_refresh' => true, );
			parent:: __construct('Ftage_Newsletter_Widget',
				esc_html__('Ftage: Newsletter','ftagementor'), $widget_ops );
		}
		/**
		...
		public function form($instance){
			...
			?>
			<p>
				<label for="<?php echo esc_attr($this->get_field_id( 'title' ) ); ?>"><?php esc_html_e('Title:', 'ftagementor');?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:' ,'ftagementor') ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('shortcode')); ?>"><?php esc_html_e('Shortcode:' ,'ftagementor') ?></label>
...
function Ftage_Newsletter_Widget() {
    register_widget( 'Ftage_Newsletter_Widget' );
}
add_action( 'widgets_init', 'Ftage_Newsletter_Widget' ); 